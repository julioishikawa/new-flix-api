...
function subscriptions() {
    return __awaiter(this, void 0, void 0, function () {
        var subscriptionData, _i, subscriptionData_1, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    _i = 0, subscriptionData_1 = subscriptionData;
                    _a.label = 2;
                case 2:
                    if (!(_i < subscriptionData_1.length)) return [3 /*break*/, 5];
                    data = subscriptionData_1[_i];
...
subscriptions().catch(function (error) {
    console.error(error);
    process.exit(1);
});
